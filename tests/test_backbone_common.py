...
class BackboneTesterMixin:
    ...
    def test_backbone_common_attributes(self):
        ...
        for backbone_class in self.all_model_classes:
            ...
            self.assertTrue(hasattr(backbone, "num_channels"))
            ...
            self.assertIsNotNone(backbone.num_channels)
            self.assertTrue(len(backbone.stage_names) == len(backbone.num_channels))
            self.assertTrue(len(backbone.channels) < len(backbone.num_channels))
