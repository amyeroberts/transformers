...
@require_torch
@require_vision
class DonutImageProcessingTest(FeatureExtractionSavingTestMixin, unittest.TestCase):
    ...
    def test_image_processor_properties(self):
        ...
        self.assertTrue(hasattr(image_processor, "do_thumbnail"))
        self.assertTrue(hasattr(image_processor, "do_align_long_axis"))
