...
@require_torch
@require_vision
class FlavaImageProcessingTest(FeatureExtractionSavingTestMixin, unittest.TestCase):
    ...
    def test_image_processor_properties(self):
        ...
        self.assertTrue(hasattr(image_processor, "masking_generator"))
        self.assertTrue(hasattr(image_processor, "codebook_do_resize"))
        self.assertTrue(hasattr(image_processor, "codebook_size"))
        self.assertTrue(hasattr(image_processor, "codebook_resample"))
        self.assertTrue(hasattr(image_processor, "codebook_do_center_crop"))
        self.assertTrue(hasattr(image_processor, "codebook_crop_size"))
        self.assertTrue(hasattr(image_processor, "codebook_do_map_pixels"))
        self.assertTrue(hasattr(image_processor, "codebook_do_normalize"))
        self.assertTrue(hasattr(image_processor, "codebook_image_mean"))
        self.assertTrue(hasattr(image_processor, "codebook_image_std"))
    ...
    def test_call_pil(self):
        ...
        encoded_images = image_processor(image_inputs[0], return_tensors="pt")
        ...
        # Test batched
        encoded_images = image_processor(image_inputs, return_tensors="pt")
        expected_height, expected_width = self.image_processor_tester.get_expected_image_size()
    ...
    def _test_call_framework(self, instance_class, prepare_kwargs):
        ...
        encoded_images = image_processor(image_inputs, return_image_mask=True, return_tensors="pt")
    ...
    def test_masking(self):
        ...
        # Test not batched input
        encoded_images = image_processor(image_inputs[0], return_image_mask=True, return_tensors="pt")
    ...
    def test_codebook_pixels(self):
        ...
        # Test not batched input
        encoded_images = image_processor(image_inputs[0], return_codebook_pixels=True, return_tensors="pt")
        ...
        # Test batched
        encoded_images = image_processor(image_inputs, return_codebook_pixels=True, return_tensors="pt")
        expected_height, expected_width = self.image_processor_tester.get_expected_codebook_image_size()
        self.assertEqual(
            encoded_images.codebook_pixel_values.shape,
            (
