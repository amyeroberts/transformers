...
@require_torch
@require_vision
class DetrImageProcessingTest(FeatureExtractionSavingTestMixin, unittest.TestCase):
    ...
    def test_equivalence_pad_and_create_pixel_mask(self):
        ...
        image_processor_2 = self.image_processing_class(do_resize=False, do_normalize=False, do_rescale=False)
        # create random PyTorch tensors
        image_inputs = prepare_image_inputs(self.image_processor_tester, equal_resolution=False, torchify=True)
        for image in image_inputs:
            self.assertIsInstance(image, torch.Tensor)
        ...
        encoded_images_with_method = image_processor_1.pad_and_create_pixel_mask(image_inputs, return_tensors="pt")
    ...
    def test_call_pytorch_with_coco_panoptic_annotations(self):
        ...
        encoding = image_processor(images=image, annotations=target, masks_path=masks_path, return_tensors="pt")
