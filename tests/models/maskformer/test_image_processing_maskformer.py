...
class MaskFormerImageProcessingTest(ImageProcessingSavingTestMixin, unittest.TestCase):
    ...
    def test_equivalence_pad_and_create_pixel_mask(self):
        ...
        encoded_images_with_method = image_processor_1.encode_inputs(image_inputs, return_tensors="pt")
        encoded_images = image_processor_2(image_inputs, return_tensors="pt")
    ...
    def test_with_size_divisor(self):
        ...
        for size_divisor in size_divisors:
            image_processor_dict = {**self.image_processor_dict, **{"size_divisibility": size_divisor}}
            image_processor = self.image_processing_class(**image_processor_dict)
            for weird_input_size in weird_input_sizes:
                inputs = image_processor([np.ones((3, *weird_input_size))], return_tensors="pt")
    ...
    def test_integration_instance_segmentation(self):
        ...
        image_processor = MaskFormerImageProcessor(reduce_labels=True, ignore_index=255, size=(512, 512))
    ...
    def test_integration_panoptic_segmentation(self):
        ...
        # create an image processor
        image_processor = MaskFormerImageProcessor(ignore_index=0, do_resize=False)
