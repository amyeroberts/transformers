...
""" Finetuning any 🤗 Transformers model for object detection leveraging 🤗 Accelerate."""
import argparse
import json
import logging
import math
...
import transformers
from transformers import AutoConfig, AutoImageProcessor, AutoModelForObjectDetection, SchedulerType, get_scheduler
...
require_version("datasets>=2.0.0", "To fix: pip install -r examples/pytorch/image-object-detection/requirements.txt")


def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tune a Transformers model on an image object detection dataset")
    parser.add_argument(
        "--dataset_name",
        type=str,
...
def main():
    ...
    send_example_telemetry("run_image_object_detection_no_trainer", args)
    ...
    if args.with_tracking:
        ...
        accelerator.init_trackers("image_object_detection_no_trainer", experiment_config)
