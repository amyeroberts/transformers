...
class SamImageProcessor(BaseImageProcessor):
    ...
    Args:
        ...
        size (`dict`, *optional*, defaults to `{"longest_edge": 1084}`):
        ...
        do_pad (`bool`, *optional*, defaults to `True`):
            ...
            `preprocess` method.
        pad_size (`dict`, *optional*, defaults to `{"height": 1084, "width": 1084}`):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        size = size if size is not None else {"longest_edge": 1084}
    ...
    def pad_image(
        ...
        **kwargs,
        ...
        padded_image = pad(image, (0, pad_bottom, 0, pad_right), data_format=data_format, **kwargs)
        return padded_image
