...
def get_image_processor_config(
    ...
    **kwargs,
    ...
    image_processor_config = get_image_processor_config("glpn-nyu")
    ...
    image_processor = AutoImageProcessor.from_pretrained("glpn-nyu")
...
class AutoImageProcessor:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs):
        ...
        >>> image_processor = AutoImageProcessor.from_pretrained("amyeroberts/test_glpn_image_processor")
    ...
    def register(config_class, image_processor_class):
        ...
        Args:
            ...
            image_processor_class_class ([`ImageProcessorMixin`]): The image processor to register.
        """
