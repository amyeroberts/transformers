...
def flip_channel_order(image: np.ndarray, data_format: Optional[ChannelDimension]) -> np.ndarray:
    ...
    Args:
        ...
        data_format (:obj:`ChannelDimension`, `optional`):
            The channel dimension format of the image. If :obj:`None`, will default to :obj:`ChannelDimension.Last`.

    Returns:
        :obj:`np.ndarray`: The image with the flipped color channels.
    """
...
class MobileViTImageProcessor(BaseImageProcessor):
    ...
    def center_crop(
        ...
        **kwargs
        ...
        length 2, then the image is cropped to (crop_size[0], crop_size[1]).
        ...
        Args:
            ...
            data_format (`str` or `ChannelDimension`, *optional*, defaults to `None`):
                The channel dimension format of the image. If not provided, it will be the same as the input image.
        """
        crop_size = crop_size if isinstance(crop_size, tuple) else (crop_size, crop_size)
    ...
    def flip_channel_order(
        ...
        Args:
            image (:obj:`np.ndarray`):
                The image, represented as a numpy array.
            data_format (:obj:`ChannelDimension`, `optional`):
                The channel dimension format of the image. If :obj:`None`, will default to
                :obj:`ChannelDimension.Last`.
        """
