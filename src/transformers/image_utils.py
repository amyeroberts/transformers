...
class ImageFeatureExtractionMixin:
    ...
    def to_pil_image(image, rescale=None):
        ...
        Args:
            ...
            rescale (`bool`, *optional*):
                ...
                default to `True` if the image type is a floating type, `False` otherwise.
        """
        return to_pil_image(image, rescale=rescale)
    ...
    def to_numpy_array(image, rescale=None, channel_first=True):
        ...
        Args:
            ...
            channel_first (`bool`, *optional*, defaults to `True`):
                Whether or not to permute the dimensions of the image to put the channel dimension first.
        """
        return to_numpy_array(image, rescale=rescale, channel_first=channel_first)
    ...
    def resize(image, size, resample=PIL.Image.BILINEAR, default_to_square=True, max_size=None):
        ...
        Returns:
            image: A resized `PIL.Image.Image`.
        """
        return resize(image, size, resample=resample, default_to_square=default_to_square, max_size=max_size)
    ...
    def flip_channel_order(image):
        ...
        Args:
            image (`PIL.Image.Image` or `np.ndarray` or `torch.Tensor`):
                ...
                be first.
        """
        return flip_channel_order(image)
